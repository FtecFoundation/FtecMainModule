...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public SecurityConfig(AuthenticationSuccessHandler successLoginHandler, WebAuthenticationDetailsSource authenticationDetails, UserDetailsService userDetailsService) {
